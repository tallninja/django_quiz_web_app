...
from model_utils.managers import InheritanceManager #requires django-model-utils
from django.db.models.signals import pre_save, post_save
from django.contrib.auth.models import User
from django.contrib import messages

#custom imports
from .helpers.csv_upload import upload_csv_file
from .helpers.validators.validator import csv_file_validator
from .signals import csv_uploaded

# Create your models here.
class CategoryManager(models.Manager):
    """
    Handles the quiz categories options
    That + symbol
    """
...
class Quiz(models.Model):
    ...
    """
    This is the quiz model where we add the quiz data
    """
    ...
    #quiz_category ...linked with category model...
    category = models.ForeignKey(
        Category, null=True, blank=True,
        verbose_name=_("Category"), on_delete=models.CASCADE)

    #quiz_random_order --Choose the ordering of the questions in the quiz--
    ...
    #quiz_max_questions --choose the maximum number of questions in the quiz--
    max_questions = models.PositiveIntegerField(
        blank=True, null=True, verbose_name=_("Max Questions"),
        help_text=_("Number of questions to be answered on each attempt."))

    #quiz_answers_at_end --choose whether the answers should be displayed at the end of the quiz--
    ...
    def save(self, force_insert=False, force_update=False, *args, **kwargs):
        ...
        #if single attempt then the results of the single attempt will be stored
        if self.single_attempt is True:
            self.exam_paper = True

        #passmark cannot go beyond 100%
    ...
    #That table where you add questions
...
class Progress(models.Model):
    ...
    def show_exams(self):
        ...
        """
        return Sitting.objects.filter(user=self.user, complete=True).order_by('-start')
...
def main():
    print(Progress.list_all_cat_scores)
